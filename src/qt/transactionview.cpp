                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received DreamTeam3 from zDT3"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zDT3"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zDT3));
