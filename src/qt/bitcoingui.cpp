                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DreamTeam3 Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DreamTeam3 address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dreamteam3: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DreamTeam3 Core"), this);
    aboutAction->setStatusTip(tr("Show information about DreamTeam3 Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DreamTeam3"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DreamTeam3 addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DreamTeam3 addresses"));
    ...
    openAction->setStatusTip(tr("Open a DreamTeam3: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DreamTeam3 Core help message to get a list with possible DreamTeam3 command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DreamTeam3 Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DreamTeam3 network", "", count));
}
...
{
    QString strTitle = tr("DreamTeam3 Core"); // default title
...
/** Creates context menu, its actions, and dreamteam3s up all the relevant signals for mouse events. */
