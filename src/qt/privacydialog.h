...
public:
    ...
    void setZDreamTeam3ControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzDT3_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzDT3_clicked();
    void on_pushButtonZDreamTeam3Control_clicked();
