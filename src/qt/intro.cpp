...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("DreamTeam3 Core"),
     ...
     * override -datadir in the dreamteam3.conf file in the default data directory
     * (to be consistent with dreamteam3d behavior)
     */
    if (dataDir != getDefaultDataDirectory())
