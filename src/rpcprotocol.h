...
enum RPCErrorCode {
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! DreamTeam3 is not connected
    ...
    RPC_WALLET_PASSDREAMTEAM3ASE_INCORRECT = -14, //! The wallet passphrase entered was incorrect
