...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 DREAMTEAM3 at the same time
    ONLY_10000 = 5,                        // find masternode outputs including locked ones (use with caution)
    STAKABLE_COINS = 6                          // UTXO's that are valid for staking
};

// Possible states for zDT3 send
enum ZerocoinSpendStatus {
    ZDREAMTEAM3_SPEND_OKAY = 0,                            // No error
    ZDREAMTEAM3_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    ZDREAMTEAM3_WALLET_LOCKED = 2,                         // Wallet was locked
    ZDREAMTEAM3_COMMIT_FAILED = 3,                         // Commit failed, reset status
    ZDREAMTEAM3_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    ZDREAMTEAM3_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    ZDREAMTEAM3_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    ZDREAMTEAM3_TRX_CREATE = 7,                            // Everything related to create the transaction
    ZDREAMTEAM3_TRX_CHANGE = 8,                            // Everything related to transaction change
    ZDREAMTEAM3_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    ZDREAMTEAM3_INVALID_COIN = 10,                         // Selected mint coin is not valid
    ZDREAMTEAM3_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    ZDREAMTEAM3_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    ZDREAMTEAM3_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    ZDREAMTEAM3_SPENT_USED_ZDREAMTEAM3 = 14                       // Coin has already been spend
};
...
public:
    ...
    */
    ...
    void setZDreamTeam3AutoBackups(bool fEnabled)
    {
