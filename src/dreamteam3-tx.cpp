...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("DreamTeam3 Core dreamteam3-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  dreamteam3-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dreamteam3 transaction") + "\n" +
                               "  dreamteam3-tx [options] -create [commands]   " + _("Create hex-encoded dreamteam3 transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dreamteam3 transaction
