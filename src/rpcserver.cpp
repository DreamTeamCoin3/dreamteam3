...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop DreamTeam3 server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "DreamTeam3 server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DreamTeam3 features */
        {"dreamteam3", "masternode", &masternode, true, true, false},
        {"dreamteam3", "listmasternodes", &listmasternodes, true, true, false},
        {"dreamteam3", "getmasternodecount", &getmasternodecount, true, true, false},
        {"dreamteam3", "masternodeconnect", &masternodeconnect, true, true, false},
        {"dreamteam3", "masternodecurrent", &masternodecurrent, true, true, false},
        {"dreamteam3", "masternodedebug", &masternodedebug, true, true, false},
        {"dreamteam3", "startmasternode", &startmasternode, true, true, false},
        {"dreamteam3", "createmasternodekey", &createmasternodekey, true, true, false},
        {"dreamteam3", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"dreamteam3", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"dreamteam3", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"dreamteam3", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"dreamteam3", "getmasternodescores", &getmasternodescores, true, true, false},
        {"dreamteam3", "mnbudget", &mnbudget, true, true, false},
        {"dreamteam3", "preparebudget", &preparebudget, true, true, false},
        {"dreamteam3", "submitbudget", &submitbudget, true, true, false},
        {"dreamteam3", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"dreamteam3", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"dreamteam3", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"dreamteam3", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"dreamteam3", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"dreamteam3", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"dreamteam3", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"dreamteam3", "checkbudgets", &checkbudgets, true, true, false},
        {"dreamteam3", "mnsync", &mnsync, true, true, false},
        {"dreamteam3", "spork", &spork, true, true, false},
        {"dreamteam3", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"dreamteam3", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use dreamteam3d, or the -server option to dreamteam3-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> dreamteam3-cli " + methodname + " " + args + "\n";
}
