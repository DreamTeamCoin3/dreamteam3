...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04f0d78663ef82de4323228e227b536f1564c29606e68f388abda0466b65d91770104e569cbf088c45fe4353fca79f7ff95ac1bc8e488f7000f23145d390a04a62");
        nDefaultPort = 17123;
        bnProofOfWorkLimit = ~uint256(0) >> 20; //20 DreamTeam3 starting difficulty is 1 / 2^12
        ...
        nZerocoinStartTime = 1667974340;
        nBlockEnforceSerialRange = 1;
        nBlockRecalculateAccumulators = ~1;
        nBlockFirstFraudulent = ~1;
        nBlockLastGoodCheckpoint = ~1;
        const char* pszTimestamp = "I think a role model is a mentor - someone you see on a daily basis, and you learn from them.";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04a8fd049a6d2ec037f9b5e229fedc328d327a04627094eba44398c6f86e147906904338489728ff435c27fa80e7c795570df7df55fb4f910e5f78d6c188cecc94") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1553490138;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 692158;
	...
	vSeeds.push_back(CDNSSeedData("95.179.133.32", "95.179.133.32"));
        ...
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 65); // T
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // DreamTeam3: 1 day
        nTargetSpacing = 1 * 60;  // DreamTeam3: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet dreamteam3 addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet dreamteam3 script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet dreamteam3 BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet dreamteam3 BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet dreamteam3 BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // DreamTeam3: 1 day
        nTargetSpacing = 1 * 60;        // DreamTeam3: 1 minutes
