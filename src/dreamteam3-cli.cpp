...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("DreamTeam3 Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  dreamteam3-cli [options] <command> [params]  " + _("Send command to DreamTeam3 Core") + "\n" +
                        "  dreamteam3-cli [options] help                " + _("List commands") + "\n" +
                        "  dreamteam3-cli [options] help <command>      " + _("Get help for a command") + "\n";
