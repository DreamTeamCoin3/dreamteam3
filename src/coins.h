...
/** 
    ...
    ****Note - for DreamTeam3 we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of dreamteam3 coming in to a transaction
