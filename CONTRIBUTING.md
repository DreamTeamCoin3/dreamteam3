Contributing to DreamTeam3 Core
============================

The DreamTeam3 Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DreamTeam3 Core project, and is not to be
confused with overall DreamTeam3 Network Protocol consensus changes.

Whether a pull request is merged into DreamTeam3 Core rests with the project merge
...
Patches that change DreamTeam3 consensus rules are considerably more involved than
...
Where a patch set proposes to change the DreamTeam3 consensus, it must have been
...
The project leader is the release manager for each DreamTeam3 Core release.
